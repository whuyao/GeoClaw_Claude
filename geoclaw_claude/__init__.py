...
__version__     = "3.1.1"
# v3.0.0 (2026-03)  SRE Phase 3：uncertainty_assessor（五维不确定性量化）、
#                   AnalysisMode（exploratory/causal 识别）、ParameterSensitivityHint、
#                   MAUP 风险评估、scale_effects_notes，344 tests 全通过
